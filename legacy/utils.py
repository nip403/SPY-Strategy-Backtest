...
@overload
def generate_toy_equity(*, expected_return: float | np.ndarray = 0, sharpe: None = None, volatility: float | np.ndarray = 0.01, beta: float | np.ndarray = 0, portfolio: Portfolio, benchmark: Optional[pd.Series] = None, distribution: Optional[Callable] = None, random_seed: Optional[int] = 42) -> pd.Series: ...

@overload
def generate_toy_equity(*, expected_return: None = None, sharpe: float | np.ndarray = 0, volatility: float | np.ndarray = 0.01, beta: float | np.ndarray = 0, portfolio: Portfolio, benchmark: Optional[pd.Series] = None, distribution: Optional[Callable] = None, random_seed: Optional[int] = 42) -> pd.Series: ... 
